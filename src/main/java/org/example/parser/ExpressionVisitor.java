...
public interface ExpressionVisitor<T> extends ParseTreeVisitor<T> {
  /**
   * Visit a parse tree produced by the {@code calculationBlock} labeled alternative in {@link
   * ExpressionParser#calc}.
   *
  ...
  /**
   * Visit a parse tree produced by the {@code expressionWithBr} labeled alternative in {@link
  ...
  /**
   * Visit a parse tree produced by the {@code expressionTimesOrDivide} labeled alternative in
   * {@link ExpressionParser#expr}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  ...
  /**
   * Visit a parse tree produced by the {@code expressionNumeric} labeled alternative in {@link
   * ExpressionParser#expr}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code expressionPlusOrMinus} labeled alternative in {@link
   * ExpressionParser#expr}.
   *
   * @param ctx the parse tree
   * @return the visitor result
